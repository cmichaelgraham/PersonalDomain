...
class BlogService {
    ...
    public GetPostDetailBySlug: (jsonRequest: PersonalDomain.Application.Operations.Request.GetPostDetailBySlugRequest) => IPromise<PersonalDomain.Application.Blogging.Models.PostDTO> = (jsonRequest) => {
        return this._httpClient.post(this._baseUrl + '/api/GetPostDetailBySlug', jsonRequest).then((httpResponse: aureliaHttpClient.IHttpResponseMessage<string>) => {
            return JSON.parse(httpResponse.response);
        });
    }  
